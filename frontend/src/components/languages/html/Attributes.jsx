...
{ items.category === 'output'?
  <div className=' bg-gray-200 w-[90%] p-5 mt-3 ml-4'>
     ...
     <button className='bg-green-600 text-white p-2 mt-3 hover:bg-green-900' onClick={()=>navigate(`/htmleditor/${items.outputQuestion}`)}>Try it Yourself!</button>
        </div>:null
}
